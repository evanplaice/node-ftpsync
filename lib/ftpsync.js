...
var sync = exports = {
  ...
  collect: function(callback) {
    ...
    async.series([
      ...
      console.log(prettyPrint(sync.local));
      console.log('Remote Files:');
      console.log(prettyPrint(sync.remote));
  ...
  consolidate: function(callback) {
    ...
    // output the results
    console.log('Updates:');
    console.log(prettyPrint(sync.update));
    console.log('Add:');
    console.log(prettyPrint(sync.add));
    console.log('Remove:');
    console.log(prettyPrint(sync.remove));
  ...
  commit: function(callback) {
    ...
    async.series([
      function(callback) {
        ...
        async.mapLimit(sync.add, settings.maxConnections, upload, function (err) {
          if (err) {
      ...
      function(callback) {
        ...
        async.mapLimit(sync.update, settings.maxConnections, upload, function (err) {
          if (err) {
